...
module TenfMediaLibrary
  class Engine < Rails::Engine
    initializer 'administrate.assets.precompile' do |app|
      app.config.assets.precompile << 'bootstrap/dist/js/bootstrap.js' if app.config.respond_to? :assets
      Administrate::Engine.add_javascript 'bootstrap/dist/js/bootstrap.js' if defined?(Administrate::Engine)
